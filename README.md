...
| 4 | Stock Market Analysis (MSFT) | How has Microsoft stock performed over time? | Price trend, moving averages & volatility analysis | [Repo](https://github.com/papastergiousp-maker/Python_Financial_Data_Analytics/blob/main/MICROSOFTSTOCK.ipynb) |
